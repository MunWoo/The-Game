    ...
    public void ItemTypeCase(ItemType itemType)
    {
        switch (itemType)
        {
            case ItemType.Weapon:
                {
                    newItemName = null;
                    var randomIndex = Random.Range(0, weaponSprites.itemSprites.Length);
            ...
            case ItemType.Shield:
                {
                    newItemName = null;
                    var randomIndex = Random.Range(0, shieldSprites.itemSprites.Length);
                    Sprite newSprite = shieldSprites.itemSprites[randomIndex];
                    switch (randomIndex)
                    {
                        default:
                            if (randomIndex >= 0 && randomIndex <= 1)
            ...
            case ItemType.Chestplate:
                {
                    newItemName = null;
                    var randomIndex = Random.Range(0, chestSprites.itemSprites.Length);
                    Sprite newSprite = chestSprites.itemSprites[randomIndex];
                    switch (randomIndex)
                    {
                        default:
                            if (randomIndex >= 0 && randomIndex <= 1)
            ...
            case ItemType.Leggins:
                {
                    newItemName = null;
                    var randomIndex = Random.Range(0, legginSprites.itemSprites.Length);
                    Sprite newSprite = legginSprites.itemSprites[randomIndex];
                    switch (randomIndex)
                    {
                        default:
                            if (randomIndex >= 0 && randomIndex <= 1)
            ...
            case ItemType.Helmet:
                {
                    newItemName = null;
                    var randomIndex = Random.Range(0, helmetSprites.itemSprites.Length);
                    Sprite newSprite = helmetSprites.itemSprites[randomIndex];
                    switch (randomIndex)
                    {
                        default:
                            if (randomIndex >= 0 && randomIndex <= 1)
